  ...
  return (
    <section className="bg-[var(--plum)] w-full py-16 md:py-24 border-y border-[var(--border)]">
      <div className="w-full max-w-[1000px] mx-auto flex flex-col gap-12 px-6">
        <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl border border-[rgba(247,241,232,0.1)] bg-[#eff4fd]">
          <Image
            src="/images/products/buudy-ipl/original_desc_1.jpg"
            alt="Skip the Salon IPL Treatment"
            width={1200}
            height={800}
        ...
        <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl border border-[rgba(247,241,232,0.1)] bg-[#eff4fd]">
          <Image
            src="/images/products/buudy-ipl/original_desc_3.jpg"
            alt="Ice Cooling IPL Technology"
            width={1200}
            height={800}
            className="w-full h-auto object-contain"
            sizes="100vw"
        ...
        <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl border border-[rgba(247,241,232,0.1)] bg-[#eff4fd]">
          <Image
            src="/images/products/buudy-ipl/original_desc_2.jpg"
            alt="4 Step IPL Process"
            width={1200}
            height={800}
            className="w-full h-auto object-contain"
            sizes="100vw"
